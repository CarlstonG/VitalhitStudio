...
import Logo from '../../assets/images/vitalhitlogo.png';
        ...
        <div className='navbar-content'>
          <div className='brand-and-toggler d-flex align-items-center justify-content-between'>
            <Link to="/" className="navbar-brand text-white text-uppercase no-wrap">
              <img src={Logo} alt="logo banner" className='logo-banner' />
            </Link>
          ...
          <div className={`navbar-collapse ${sidebarStatus ? "show" : " "}`}>
            ...
            <ul className='navbar-nav'>
              ...
              <li className='nav-item'>
                <Link to="/creators" className='nav-link'>Our Game</Link>
              </li>
              <li className='nav-item'>
                <Link to="/stores" className='nav-link'>Career</Link>
              </li>
              <li className='nav-item'>
                <Link to="/games" className='nav-link'>About us</Link>
              </li>
            </ul>
